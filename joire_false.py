...
text_6 = 'よってこの数式では一列目が12と7、にれつめが3と7になります。'
layout.append(
    [
...
text_7 = 'たすき掛けをしたものにかっこをつけると因数分解の解になるので、かっこ12エックスひく7かっことじ、かっこ2エックスたす3かっことじは0となり、'
layout.append(
    [
...
text_8 = 'エックスについての方程式を解くとエックスイコール12/7 と2/3となります。'
layout.append(
    [
